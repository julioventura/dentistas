...
export const CAMPOS_FICHAS_DENTES_ENDO: Campo[] = [
  ...
  // Canal 1
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1Nome', tipo: 'text', label: 'Canal 1 - Nome/Sigla' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1Ref', tipo: 'text', label: 'Canal 1 - Referência Coronária' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1CAD', tipo: 'number', label: 'Canal 1 - CAD – comprimento aparente do dente' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1CRI', tipo: 'number', label: 'Canal 1 - CRI – comprimento real do instrumento (CAD-2)' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1CPT', tipo: 'number', label: 'Canal 1 - CPT – comprimento provisório de trabalho (CAD-4)' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1CRD', tipo: 'number', label: 'Canal 1 - CRD – comprimento real do dente' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1CRT', tipo: 'number', label: 'Canal 1 - CRT – comprimento real de trabalho' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1IAF', tipo: 'text', label: 'Canal 1 - IAF – Instrumento apical foraminal (Patência)' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1IAI', tipo: 'text', label: 'Canal 1 - IAI - Instrumento inicial apical' },
  { grupo: '21) Canais Radiculares - Canal 1', nome: 'canal1IM', tipo: 'text', label: 'Canal 1 -IM – Instrumento de memória (Último instrumento do preparo apical)' },
  
  // Canal 2
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2Nome', tipo: 'text', label: 'Canal 2 - Nome/Sigla' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2Ref', tipo: 'text', label: 'Canal 2 - Referência Coronária' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2CAD', tipo: 'number', label: 'Canal 2 - CAD – comprimento aparente do dente' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2CRI', tipo: 'number', label: 'Canal 2 - CRI – comprimento real do instrumento (CAD-2)' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2CPT', tipo: 'number', label: 'Canal 2 - CPT – comprimento provisório de trabalho (CAD-4)' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2CRD', tipo: 'number', label: 'Canal 2 - CRD – comprimento real do dente' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2CRT', tipo: 'number', label: 'Canal 2 - CRT – comprimento real de trabalho' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2IAF', tipo: 'text', label: 'Canal 2 - IAF – Instrumento apical foraminal (Patência)' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2IAI', tipo: 'text', label: 'Canal 2 - IAI - Instrumento inicial apical' },
  { grupo: '21) Canais Radiculares - Canal 2', nome: 'canal2IM', tipo: 'text', label: 'Canal 2 -IM – Instrumento de memória (Último instrumento do preparo apical)' },
  
  // Canal 3
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3Nome', tipo: 'text', label: 'Canal 3 - Nome/Sigla' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3Ref', tipo: 'text', label: 'Canal 3 - Referência Coronária' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3CAD', tipo: 'number', label: 'Canal 3 - CAD – comprimento aparente do dente' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3CRI', tipo: 'number', label: 'Canal 3 - CRI – comprimento real do instrumento (CAD-2)' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3CPT', tipo: 'number', label: 'Canal 3 - CPT – comprimento provisório de trabalho (CAD-4)' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3CRD', tipo: 'number', label: 'Canal 3 - CRD – comprimento real do dente' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3CRT', tipo: 'number', label: 'Canal 3 - CRT – comprimento real de trabalho' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3IAF', tipo: 'text', label: 'Canal 3 - IAF – Instrumento apical foraminal (Patência)' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3IAI', tipo: 'text', label: 'Canal 3 - IAI - Instrumento inicial apical' },
  { grupo: '21) Canais Radiculares - Canal 3', nome: 'canal3IM', tipo: 'text', label: 'Canal 3 -IM – Instrumento de memória (Último instrumento do preparo apical)' },
  
  // Canal 4
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4Nome', tipo: 'text', label: 'Canal 4 - Nome/Sigla' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4Ref', tipo: 'text', label: 'Canal 4 - Referência Coronária' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4CAD', tipo: 'number', label: 'Canal 4 - CAD – comprimento aparente do dente' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4CRI', tipo: 'number', label: 'Canal 4 - CRI – comprimento real do instrumento (CAD-2)' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4CPT', tipo: 'number', label: 'Canal 4 - CPT – comprimento provisório de trabalho (CAD-4)' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4CRD', tipo: 'number', label: 'Canal 4 - CRD – comprimento real do dente' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4CRT', tipo: 'number', label: 'Canal 4 - CRT – comprimento real de trabalho' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4IAF', tipo: 'text', label: 'Canal 4 - IAF – Instrumento apical foraminal (Patência)' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4IAI', tipo: 'text', label: 'Canal 4 - IAI - Instrumento inicial apical' },
  { grupo: '21) Canais Radiculares - Canal 4', nome: 'canal4IM', tipo: 'text', label: 'Canal 4 -IM – Instrumento de memória (Último instrumento do preparo apical)' },
  
  // Canal 5
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5Nome', tipo: 'text', label: 'Canal 5 - Nome/Sigla' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5Ref', tipo: 'text', label: 'Canal 5 - Referência Coronária' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5CAD', tipo: 'number', label: 'Canal 5 - CAD – comprimento aparente do dente' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5CRI', tipo: 'number', label: 'Canal 5 - CRI – comprimento real do instrumento (CAD-2)' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5CPT', tipo: 'number', label: 'Canal 5 - CPT – comprimento provisório de trabalho (CAD-4)' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5CRD', tipo: 'number', label: 'Canal 5 - CRD – comprimento real do dente' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5CRT', tipo: 'number', label: 'Canal 5 - CRT – comprimento real de trabalho' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5IAF', tipo: 'text', label: 'Canal 5 - IAF – Instrumento apical foraminal (Patência)' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5IAI', tipo: 'text', label: 'Canal 5 - IAI - Instrumento inicial apical' },
  { grupo: '21) Canais Radiculares - Canal 5', nome: 'canal5IM', tipo: 'text', label: 'Canal 5 -IM – Instrumento de memória (Último instrumento do preparo apical)' },
