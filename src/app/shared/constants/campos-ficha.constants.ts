...
export const CAMPOS_FICHAS_DENTES_ENDO: Campo[] = [
  ...
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Integridade da Coroa', nome: 'ausente', tipo: 'boolean', label: 'Ausente' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Alterações da Coroa', nome: 'alteracaoCor', tipo: 'boolean', label: 'Alteração de cor' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Alterações da Coroa', nome: 'carie', tipo: 'boolean', label: 'Cárie' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Alterações da Coroa', nome: 'fratura', tipo: 'boolean', label: 'Fratura' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Restaurações', nome: 'coroaPermanente', tipo: 'boolean', label: 'Coroa Permanente' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Restaurações', nome: 'restaurado', tipo: 'boolean', label: 'Restaurada' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Restaurações', nome: 'coroaProvisoria', tipo: 'boolean', label: 'Provisória' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Alteração Pulpar', nome: 'exposicaoPulpar', tipo: 'boolean', label: 'Exposição pulpar' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Alteração Pulpar', nome: 'selamentoProvisorio', tipo: 'boolean', label: 'Selamento provisório' },
  // Aspectos Clínicos dos Tecidos Moles
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Tecidos Moles', nome: 'edemaintraoral', tipo: 'boolean', label: 'Edema intra-oral' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Tecidos Moles', nome: 'edemaextraoral', tipo: 'boolean', label: 'Edema extra-oral' },
  { grupo: '01) Aspectos Clínicos', subgrupo: 'Tecidos Moles', nome: 'fistula', tipo: 'boolean', label: 'Fístula' },

  // Avaliação da Dor
  { grupo: '02) Dor', subgrupo: 'Presença', nome: 'dorPresente', tipo: 'boolean', label: 'Dor: Presente?' },
  { grupo: '02) Dor', subgrupo: 'Presença', nome: 'nivelDor', tipo: 'number', label: 'Intensidade (1/leve - 10/severa)' },
  { grupo: '02) Dor', subgrupo: 'Presença', nome: 'localizacaoDorLocalizada', tipo: 'boolean', label: 'Dor Localizada' },
  { grupo: '02) Dor', subgrupo: 'Presença', nome: 'localizacaoDorDifusa', tipo: 'boolean', label: 'Dor Difusa' },
  { grupo: '02) Dor', subgrupo: 'Presença', nome: 'denteLocalizado', tipo: 'text', label: 'Dente(s) com dor (se localizada)' },
  { grupo: '02) Dor', subgrupo: 'Presença', nome: 'regiaoDor', tipo: 'text', label: 'Região da dor (se difusa)' },

  // Frequência da Dor
  { grupo: '02) Dor', subgrupo: 'Frequência', nome: 'frequenciaConstante', tipo: 'boolean', label: 'Constante' },
  { grupo: '02) Dor', subgrupo: 'Frequência', nome: 'frequenciaIntermitente', tipo: 'boolean', label: 'Intermitente' },
  { grupo: '02) Dor', subgrupo: 'Frequência', nome: 'frequenciaOcasional', tipo: 'boolean', label: 'Ocasional' },

  // Gatilho da Dor
  { grupo: '02) Dor', subgrupo: 'Gatilho', nome: 'gatilhoDorFrio', tipo: 'boolean', label: 'Iniciada por frio' },
  { grupo: '02) Dor', subgrupo: 'Gatilho', nome: 'gatilhoDorCalor', tipo: 'boolean', label: 'Iniciada por calor' },
  { grupo: '02) Dor', subgrupo: 'Gatilho', nome: 'gatilhoDorMastigação', tipo: 'boolean', label: 'Iniciada por mastigação' },
  { grupo: '02) Dor', subgrupo: 'Gatilho', nome: 'gatilhoDorDoce', tipo: 'boolean', label: 'Iniciada por doce' },
  { grupo: '02) Dor', subgrupo: 'Gatilho', nome: 'gatilhoDorEspontanea', tipo: 'boolean', label: 'Iniciada espontaneamente' },

  // Alívio da Dor
  { grupo: '02) Dor', subgrupo: 'Alívio', nome: 'alivioDorFrio', tipo: 'boolean', label: 'Aliviada por frio' },
  { grupo: '02) Dor', subgrupo: 'Alívio', nome: 'alivioDorCalor', tipo: 'boolean', label: 'Aliviada por calor' },
  { grupo: '02) Dor', subgrupo: 'Alívio', nome: 'alivioDorAnalgesicos', tipo: 'boolean', label: 'Aliviada por analgesicos' },

  // Duração da Dor
  { grupo: '02) Dor', subgrupo: 'Duração', nome: 'duracaoSegundos', tipo: 'boolean', label: 'Duração de segundos' },
  { grupo: '02) Dor', subgrupo: 'Duração', nome: 'duracaoMinutos', tipo: 'boolean', label: 'Duração de minutos' },
  { grupo: '02) Dor', subgrupo: 'Duração', nome: 'duracaoHoras', tipo: 'boolean', label: 'Duração de horas' },


  // Exame Radiográfico Inicial – Câmara Pulpar
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioCarie', tipo: 'boolean', label: 'Cárie' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioRestauracao', tipo: 'boolean', label: 'Restauração' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioComunicacao', tipo: 'boolean', label: 'Comunicação com meio bucal' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioAcessadaProvisorio', tipo: 'boolean', label: 'Acessada com provisório' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioDensInDente', tipo: 'boolean', label: 'Dens in Dente' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioNoduloPulpar', tipo: 'boolean', label: 'Nódulo pulpar' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioAtresica', tipo: 'boolean', label: 'Atrésica' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Câmara Pulpar', nome: 'radioAmpla', tipo: 'boolean', label: 'Ampla' },

  // Exame Radiográfico Inicial – Canais Radiculares
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'calcificado', tipo: 'boolean', label: 'Calcificação' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'curvaturaAcentuada', tipo: 'boolean', label: 'Curvatura acentuada' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'medicacaoIntracanal', tipo: 'boolean', label: 'Medicação intracanal' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'presencaMaterialObturador', tipo: 'boolean', label: 'Material obturador presente' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'linhaFraturaLocalizacao', tipo: 'text', label: 'Linha de fratura - Localização' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'limaFraturadaLocalizacao', tipo: 'text', label: 'Lima fraturada - Localização' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'perfuracaoLocalizacao', tipo: 'text', label: 'Perfuração - Localização' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'tipoRetentor1', tipo: 'boolean', label: 'Retentor intrarradicular Metálico' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'tipoRetentor2', tipo: 'boolean', label: 'Retentor intrarradicular de Fibra de vidro' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'reabsorcao1', tipo: 'boolean', label: 'Reabsorção Externa' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'reabsorcao2', tipo: 'boolean', label: 'Reabsorção Interna' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'reabsorcao3', tipo: 'boolean', label: 'Reabsorção Lateral' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'reabsorcao4', tipo: 'boolean', label: 'Reabsorção Apical' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'reabsorcao5', tipo: 'boolean', label: 'Reabsorção Anquilose' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'localizacaoReabsorcao', tipo: 'text', label: 'Localização da reabsorção' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'regiaoFurca1', tipo: 'boolean', label: 'Região de furca integra' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Canais Radiculares', nome: 'regiaoFurca2', tipo: 'boolean', label: 'Região de furca alterada' },

  // Exame Radiográfico Inicial – Região Periapical
  { grupo: '03) Radiografia Inicial', subgrupo: 'Região Periapical', nome: 'PeriapicalSemAlteracao', tipo: 'boolean', label: 'Sem alteração' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Região Periapical', nome: 'PeriapicalAumentoDeEspaco', tipo: 'boolean', label: 'Aumento de espaço do ligamento periodontal' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Região Periapical', nome: 'PeriapicalRadiolucidezApical', tipo: 'boolean', label: 'Sem alteração' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Região Periapical', nome: 'PeriapicalHipercementose', tipo: 'boolean', label: 'Hipercementose' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Região Periapical', nome: 'PeriapicalOsteite', tipo: 'boolean', label: 'Osteíte condensante' },
  { grupo: '03) Radiografia Inicial', subgrupo: 'Região Periapical', nome: 'PeriapicalExtravasamento', tipo: 'boolean', label: 'Material obturador extravasado ' },

  // Teste de Sensibilidade
  { grupo: '04) Testes', subgrupo: 'Controle de Sensibilidade', nome: 'denteControle', tipo: 'text', label: 'Dente controle' },
  { grupo: '04) Testes', subgrupo: 'Controle de Sensibilidade', nome: 'denteSuspeito', tipo: 'text', label: 'Dente suspeito' },
  { grupo: '04) Testes', subgrupo: 'Sensibilidade à dor', nome: 'respostaTestePositiva', tipo: 'boolean', label: 'Resposta positiva' },
  { grupo: '04) Testes', subgrupo: 'Sensibilidade à dor', nome: 'respostaTesteNegativa', tipo: 'boolean', label: 'Resposta negativa' },
  { grupo: '04) Testes', subgrupo: 'Duração da dor', nome: 'duracaoIgualControle', tipo: 'boolean', label: 'Duração igual ao controle' },
  { grupo: '04) Testes', subgrupo: 'Duração da dor', nome: 'duracaoMaisLenta', tipo: 'boolean', label: 'Retorno mais lento que o controle' },
  { grupo: '04) Testes', subgrupo: 'Intensidade da dor', nome: 'intensidadeIgualControle', tipo: 'boolean', label: 'Intensidade igual ao controle' },
  { grupo: '04) Testes', subgrupo: 'Intensidade da dor', nome: 'intensidadeMaisAgudo', tipo: 'boolean', label: 'Intensidade mais aguda que o controle' },
  // Testes Clínicos
  { grupo: '04) Testes', subgrupo: 'Sondagem, mobilidade, palpação e percussão', nome: 'testeSondagem', tipo: 'boolean', label: 'Sondagem: Bolsa Periodontal' },
  { grupo: '04) Testes', subgrupo: 'Sondagem, mobilidade, palpação e percussão', nome: 'testeMobilidade', tipo: 'boolean', label: 'Mobilidade' },
  { grupo: '04) Testes', subgrupo: 'Sondagem, mobilidade, palpação e percussão', nome: 'testePalpacao', tipo: 'boolean', label: 'Palpação' },
  { grupo: '04) Testes', subgrupo: 'Sondagem, mobilidade, palpação e percussão', nome: 'testePercussaoHorizontal', tipo: 'boolean', label: 'Percussão horizontal' },
